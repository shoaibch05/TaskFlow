...
const TopBar = ({ onMenuClick }) => {
  ...
  return (
    <div className="flex px-4 bg-gray-800 items-center justify-between p-2 text-white shadow-[0px_-1px_3px_2px_rgba(0,0,0,0.25)] z-50 relative">
      {/* Left section with logo & hamburger for mobile */}
      ...
      <div className="hidden sm:block flex-1 max-w-md px-4">
        <input
          ...
          className="w-full px-5 py-2 bg-gray-600 rounded-lg"
        />
      </div>
